...
export const fetchFavs = (dataToSubmit) => {
    ...
    return (dispatch) => {
        ...
        axios.post('https://recipe-apii.herokuapp.com/api/favourites/getFavourites' , dataToSubmit)
        .then(response => {
...
export const uploadFavs = (dataToSubmit) => {
    ...
    return (dispatch) => {
        ...
        axios.post('https://recipe-apii.herokuapp.com/api/favourites/upload' , dataToSubmit)
        .then(response => {
            if(response.data.success){
